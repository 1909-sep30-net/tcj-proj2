...
let CategoryComponent = class CategoryComponent {
    ...
    constructor(sdService, helpbypros, fb) {
...
let QuestionsComponent = class QuestionsComponent {
    constructor(route, helpbypros, sdService) {
        this.route = route;
        this.helpbypros = helpbypros;
        this.sdService = sdService;
    }
...
let HelpByProsAPISerivce = class HelpByProsAPISerivce {
    constructor(httpClient, auth) {
        ...
        auth.userProfile$.subscribe(user => {
            if (user) {
                this.getUser(user.nickname).catch((err) => {
    ...
    getCategoryList() {
        const url = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].HelpBYProsApiBaseUrl}/forum/category`;
        return this.httpClient.get(url).toPromise();
    }
    getACategoryQuestioList(category) {
        const url = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].HelpBYProsApiBaseUrl}/home/category/${category}`;
        return this.httpClient.get(url).toPromise();
    }
    getUser(username) {
        const url = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].HelpBYProsApiBaseUrl}/user/${username}`;
        return this.httpClient.get(url).toPromise();
    }
    createUser(user) {
        const url = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].HelpBYProsApiBaseUrl}/user/CreateUser`;
        return this.httpClient.post(url, user).toPromise();
    }
    createQuestion(q) {
        const url = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].HelpBYProsApiBaseUrl}/forum/AddQuestion`;
        return this.httpClient.post(url, q).toPromise();
    }
};
HelpByProsAPISerivce.ctorParameters = () => [
...
class QuestionItems {
    constructor(Category, UserQuestion, QuestionBody, Username, QuestionID) {
...
let NavbarComponent = class NavbarComponent {
    constructor(auth, HelpByProsApi) {
        this.auth = auth;
